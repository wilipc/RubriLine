...
<?php endif; ?>
                ...
                <?php if(Auth::user()->profile_photo_path): ?>
                                        <img class="h-8 w-8 rounded-full object-cover" src="/storage/<?php echo e(Auth::user()->avatar); ?>" alt="<?php echo e(Auth::user()->name); ?>" />
                                    <?php else: ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\rubriline\resources\views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>