...
<?php $component->withAttributes([]); ?>
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div class="mt-6 bg-white">
            ...
            <img src="<?php echo e(asset('/img/logo02.png')); ?>" alt="" style="width:150px;">
            </div>
                ...
                <div class="p-2 mod-inv">
                    ...
                    <div class="flex items-center">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <img src="<?php echo e(asset ('/img/post.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
                <div class="p-12 pad-1 pt-1 pb-1">
                    <div class="p-12 pad-2 pt-1">
                        <div class="flex items-center justify-center ">
                            <img src="<?php echo e(asset ('/img/loguser.png')); ?>" alt="">
                        </div>
                        <div class="ml-1">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
...
<?php endif; ?>
                                ...
                                <button onclick="window.location.href='<?php echo e(url('auth/google')); ?>'" class="input-group flex items-center rounded-pill border-primary border-3 btn justify-center mt-4 text-center" type="">
                                    <div class=" radiusfin ">
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\rubriline\resources\views/auth/login.blade.php ENDPATH**/ ?>