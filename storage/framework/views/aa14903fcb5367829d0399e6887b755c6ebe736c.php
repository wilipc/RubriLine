...
} elseif ($_instance->childHasBeenRendered('9AZGAEt')) {
    $componentId = $_instance->getRenderedChildComponentId('9AZGAEt');
    $componentTag = $_instance->getRenderedChildComponentTagName('9AZGAEt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9AZGAEt');
} else {
    $response = \Livewire\Livewire::mount('navigation-menu');
    $html = $response->html();
    $_instance->logRenderedChild('9AZGAEt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <!-- Left navbar links -->
                ...
                <div class="sidebar bluecol">
                    ...
                    <div class="user-panel border-b1-orage mt-3 pb-3 mb-3" >
                        ...
                        <div class="info" style="overflow:Initial !important;">
                            <a href="#" class="btn d-block text-light" data-toggle="modal" data-target="#modal-sm"><strong><?php echo e(Auth::user()->name); ?></strong></a>
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="button" class="btn btn-primary" onclick="<?php echo e('logout'); ?>">Si</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
...
<?php /**PATH C:\xampp\htdocs\rubriline\resources\views/layouts/est.blade.php ENDPATH**/ ?>